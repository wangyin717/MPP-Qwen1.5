...
# 新加的minigpt4_pretrain
@registry.register_builder("minigpt4_pretrain")
class Minigpt4PretrainBuilder(BaseDatasetBuilder):
    train_dataset_cls = InstructionDataset
    DATASET_CONFIG_DICT = {
        'default': 'configs/datasets/minigpt4_pretrain/defaults.yaml'
    }
